...
for num = 1:file_num/2
    ...
    output_file_name = "drv_table_classified_combined_00" + num2str(num)+".csv";

    drv_data_1 = readtable("./02_drv_table_classified/" + input_file_name_1);
    drv_data_2 = readtable("./02_drv_table_classified/" + input_file_name_2);
    ...
    writetable(drv_data_combined, "./02_drv_table_combined/" + output_file_name)
